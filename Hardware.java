...
public class Hardware {
    ...
    public void initHardware(HardwareMap map)
    {
        ...
        leftShoot = hwMap.dcMotor.get("left shoot");
        rightShoot = hwMap.dcMotor.get("right shoot");
        ...
        throwing = hwMap.servo.get("throw");
        ...
        choo.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
